...
namespace Partify.DataAccess.Migrations
{
    ...
    [Migration("20240717021100_RenameAdPropertyValueToAdCategoryPropertyValue")]
    partial class RenameAdPropertyValueToAdCategoryPropertyValue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Partify.Domain.Entities.Ads.AdCategoryPropertyValue", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("AdCategoryPropertyId");

                    b.HasIndex("AdId");

                    b.ToTable("AdCategoryPropertyValues");
                });
            ...
            modelBuilder.Entity("Partify.Domain.Entities.Ads.AdCategoryPropertyValue", b =>
                {
                    b.HasOne("Partify.Domain.Entities.Ads.AdCategoryProperty", "AdCategoryProperty")
                        .WithMany()
                        .HasForeignKey("AdCategoryPropertyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("AdCategoryProperty");
                });
